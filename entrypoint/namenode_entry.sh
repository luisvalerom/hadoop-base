...
###
### modificado para habilitar persistencia
###
# Check if namenode dir exists
echo $ENSURE_NAMENODE_DIR
namedir=$ENSURE_NAMENODE_DIR
if [ ! -d $namedir ]; then
...
#     CLUSTERID_OPTS="-clusterid $ENSURE_NAMENODE_CLUSTERID -nonInteractive"
#   fi
...
# fi
###
### FIN modificado para habilitar persistencia
###
